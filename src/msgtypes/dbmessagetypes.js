...
MessageTypes = Object.freeze({ 
        ...
        REGISTER_RPCSERVER:        21,
        CONNECT_TO_RPCSERVER:	   22,

        UNREGISTER_DISCONNECT_RPCSERVER: 23,
        RPCSERVER_KEEPALIVE:     24,
        RESPONSE_TO_CALL:	     27,
        CALL_RPC_FUNCTION:		 26,
        RPCSERVER_CLIENT_ERROR:  28,
        RPCSERVER_SERVER_ERROR:  29,
        END_RPC_CALL:            30,  
        LATENCY:                 99,
        SYSTEM_MSG:               0,   
        PARTICIPANT_JOIN:         17,
